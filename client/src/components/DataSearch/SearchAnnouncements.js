/**
 * SearchAnnouncements.js
 * 
 * This is a React component that allows the user to search for announcements by title. It includes a search bar, a clear button, and a paginated display of the search results.
 * 
 ...
 * 
 * The search term and page number are managed by the state. When the search button is clicked, the `/announcements/search/${searchTerm}?page=${page}` endpoint is called to fetch the search results. The search results are displayed in a grid, with each announcement being a link to its detail page.
 * 
 ...
 * 
 * @module components/SearchAnnouncements
 */
